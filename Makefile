...
LD		= $(CCACHE) $(LLVM_PREFIX)ld.lld$(LLVM_SUFFIX)
AR		= $(CCACHE) $(LLVM_PREFIX)llvm-ar$(LLVM_SUFFIX)
NM		= $(LLVM_PREFIX)llvm-nm$(LLVM_SUFFIX)
OBJCOPY		= $(CCACHE) $(LLVM_PREFIX)llvm-objcopy$(LLVM_SUFFIX)
OBJDUMP		= $(CCACHE) $(LLVM_PREFIX)llvm-objdump$(LLVM_SUFFIX)
READELF		= $(CCACHE) $(LLVM_PREFIX)llvm-readelf$(LLVM_SUFFIX)
